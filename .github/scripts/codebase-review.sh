...
FILES=$(find . -type f \( -name "*.ts" -o -name "*.svelte" -o -name "*.js" -o -name "*.yaml" -o -name "*.yml" -o -name "*.json" -o -name "*.md" \) ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/.svelte-kit/*" ! -path "*/build/*" ! -path "*/dist/*" | head -100)
...
## Directory Structure
$(find . -type d ! -path '*/node_modules/*' ! -path '*/target/*' ! -path '*/.git/*' ! -path '*/.svelte-kit/*' ! -path '*/build/*' ! -path '*/dist/*' | head -50)
